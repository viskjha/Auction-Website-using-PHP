        ...
        <div id="auction" class="col-md-3">
            <div class="thumbnail">
                ...
                <div class="caption">
                    ...
                    <h4><b><a href="productpage.php?auct=<?php echo $item['auction_id']; ?>"><?php echo $item['label']; ?> (<?php echo $item['state']; ?>)</a></b></h4>
                    <h5><b>Description:</b></h5><p><?php echo $item['description']; ?></p>
                </div>
                <div class="row viewings">
                    <h4><div class="col-md-6">Viewings: <?php echo $item['viewings']; ?></div></h4>
                    <div class="col-md-6 text-right">
                        <h4><?php
                        $now = new DateTime();
                        $endDate = new DateTime($item['end_time']);
                        $interval = $endDate -> diff($now);
                        echo $interval -> format('%a Days and %h Hours'); ?></h4>
                    </div>
                </div><br>
                <center><h3><a href="productpage.php?auct=<?php echo $item['auction_id']; ?>">Show Detail</a></h3></center>
            </div>
        </div>
        <?php }} ?>
    </div>
